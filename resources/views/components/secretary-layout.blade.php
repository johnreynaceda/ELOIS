...
-->
  <div class="min-h-full">
    ...
    <div
      class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-300 lg:bg-gray-300 lg:pt-5 lg:pb-4">
              ...
              <span class="flex w-full items-center justify-between">
                <span class="flex min-w-0 items-center justify-between space-x-3">
                  ...
                  <span class="flex min-w-0 flex-1 flex-col">
                    <span
                      class="truncate uppercase text-sm font-medium text-gray-900">{{ auth()->user()->name }}</span>
        ...
        <nav class="mt-6 px-3">
          <div class="space-y-1">
            ...
            <a href="{{ route('secretary.dashboard') }}"
              class=" {{ request()->routeIs('secretary.dashboard') ? 'bg-gray-100' : 'bg-gray-300' }} hover:bg-gray-200 text-gray-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
              aria-current="page">
          ...
          <div class="mt-8 border-t">
            ...
            <div class="mt-1 space-y-1" role="group" aria-labelledby="desktop-teams-headline">
              {{-- <a href="{{ route('secretary.request') }}"
                class=" {{ request()->routeIs('secretary.request') ? 'bg-gray-100' : 'bg-gray-300' }} hover:bg-gray-200 text-gray-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                aria-current="page">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  class="fill-gray-700 mr-3 flex-shrink-0 h-6 w-6">
                  <path fill="none" d="M0 0h24v24H0z" />
              ...
              <a href="{{ route('secretary.request') }}"
                ...
                <span
                  class="bg-gray-400 text-white  group-hover:bg-white group-hover:text-gray-700 ml-3 inline-block py-0.5 px-3 text-xs font-medium rounded-full">{{ App\Models\LawyerAppointment::where('is_accepted', false)->count() }}</span>
              </a>
              <a href="{{ route('secretary.appointment') }}"
                class="{{ request()->routeIs('secretary.appointment') ? 'bg-gray-100' : 'bg-gray-300' }} hover:bg-gray-200 text-gray-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                aria-current="page">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  class="fill-gray-700 mr-3 flex-shrink-0 h-6 w-6">
                  <path fill="none" d="M0 0h24v24H0z" />
                ...
                <span
                  class="bg-gray-400 text-white  group-hover:bg-white group-hover:text-gray-700 ml-3 inline-block py-0.5 px-3 text-xs font-medium rounded-full">{{ App\Models\LawyerAppointment::where('is_accepted', true)->count() }}</span>
              </a>

              {{-- <a href="{{ route('secretary.calendar') }}"
                class=" {{ request()->routeIs('secretary.calendar') ? 'bg-gray-100' : 'bg-gray-300' }} hover:bg-gray-200 text-gray-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                aria-current="page">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  class="fill-gray-700 mr-3 flex-shrink-0 h-6 w-6">
                  <path fill="none" d="M0 0h24v24H0z" />
              ...
              <a href="{{ route('secretary.reports') }}"
                class="{{ request()->routeIs('secretary.reports') ? 'bg-gray-100' : 'bg-gray-300' }} bg-gray-100 hover:bg-gray-200 text-gray-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                aria-current="page">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  class="fill-gray-700 mr-3 flex-shrink-0 h-6 w-6">
                  <path fill="none" d="M0 0h24v24H0z" />
      ...
      <main class="flex-1">
        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <div class="min-w-0 flex-1">
            <h1 class="text-lg font-medium leading-6 text-gray-600 sm:truncate">LAW OFFICE INFORMATION SYSTEM</h1>
          </div>
        </div>
        <!-- Pinned projects -->
